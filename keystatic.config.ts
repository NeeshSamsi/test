    ...
    homepage: singleton({
      ...
      schema: {
        headline: fields.text({
          ...
          description: "The main underlined headline shown in the main section.",
          validation: {
            length: { min: 1 },
          },
        }),
        ...
        // storyHeadline: fields.text({
        //   label: "Headline - Story section",
        //   description: "Shows as the heading of the Story Section.",
        //   validation: {
        //     length: { min: 1 },
        //   },
        // }),
